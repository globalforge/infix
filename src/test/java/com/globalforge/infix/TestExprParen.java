...
public class TestExprParen {
    static final String sampleMessage2 = "8=FIX.4.4" + '\u0001' + "9=1000"
        ...
        + '\u0001' + "45=0" + '\u0001' + "453=2" + '\u0001' + "448=1.5"
        + '\u0001' + "447=eb8cd" + '\u0001' + "78=2" + '\u0001' + "79=\"STR\""
        + '\u0001' + "661=8" + '\u0001' + "573=-33" + '\u0001' + "366=999"
        + '\u0001' + "79=\"MCS\"" + '\u0001' + "661=22" + '\u0001' + "573=33"
        + '\u0001' + "366=-999.99" + '\u0001' + "448=3" + '\u0001'
        + "447=8dhosb" + '\u0001' + "207=\"USA\"" + '\u0001' + "10=004";
    ...
    public void test4() {
        try {
            ...
            sampleRule = "&99=&453[0]->&448+(&453[1]->&802[1]->&523*2)"; // 1+(3*2)
            rules = new InfixActions(sampleRule);
            result = rules.transformFIXMsg(TestExprParen.sampleMessage1, true);
     ...
     */
    static final String Parties_1 = "448=1" + '\u0001' + "447=1" + '\u0001'
        + "452=1" + '\u0001';
    static final String PtysSubGrp_1 = "523=1" + '\u0001' + "803=1" + '\u0001';
    static final String Parties_2 = "448=2" + '\u0001' + "447=2" + '\u0001'
        + "452=2" + '\u0001';
    static final String PtysSubGrp_2 = "523=2" + '\u0001' + "803=2" + '\u0001';
    static final String PtysSubGrp_3 = "523=3" + '\u0001' + "803=3" + '\u0001';
    // /////////////////////
    static final String sampleMessage1_part2 = "453=2" + '\u0001'
        + TestExprParen.Parties_1 + "802=1" + '\u0001'
        + TestExprParen.PtysSubGrp_1 + TestExprParen.Parties_2 + "802=2"
        + '\u0001' + TestExprParen.PtysSubGrp_2 + TestExprParen.PtysSubGrp_3
        + "10=004";
    // /////////////////////
    static final String sampleMessage1 = TestExprParen.sampleMessage1_part1
        + TestExprParen.sampleMessage1_part2;

    @Test
    public void test6() {
        try {
            sampleRule = "&453[0]->&448=&453[1]->&802[1]->&803+&9"; // 3 + 10
            rules = new InfixActions(sampleRule);
            result = rules.transformFIXMsg(TestExprParen.sampleMessage1);
            resultStore = StaticTestingUtils.parseMessage(result);
    ...
    static final String UnderlyingInstrument_1_1 = "311=1" + '\u0001' + "312=1"
        + '\u0001' + "309=1" + '\u0001' + "305=1" + '\u0001';
    static final String UnderlyingInstrument_1_2 = "462=7" + '\u0001' + "463=1"
        + '\u0001';
    static final String UnderlyingInstrument_2_1 = "311=2" + '\u0001' + "312=2"
        + '\u0001' + "309=2" + '\u0001' + "305=2" + '\u0001';
    ...
    static final String sampleMessage2_part2 = "711=2" + '\u0001'
        + TestExprParen.UnderlyingInstrument_1_1 + "457=1" + '\u0001'
        + TestExprParen.UndSecAltIDGrp_1
        + TestExprParen.UnderlyingInstrument_1_2
    ...
    public void test10() {
        try {
            sampleRule =
                "&711[0]->&457[0]->&458 = &711[1]->&457[1]->&458 + &711[0]->&311"; // 3
                                                                                   // +
                                                                                   // 1
            rules = new InfixActions(sampleRule);
            result = rules.transformFIXMsg(TestExprParen.sampleMessage3);
    ...
    public void test11() {
        try {
            sampleRule =
                "&711[1]->&457[1]->&458 = &711[0]->&457[0]->&458 + &711[1]->&311"; // 1
                                                                                   // +
                                                                                   // 2
            rules = new InfixActions(sampleRule);
            result = rules.transformFIXMsg(TestExprParen.sampleMessage3);
    ...
    public void test14() {
        try {
            ...
            sampleRule = "&215[1]->&218 = 42";
            rules = new InfixActions(sampleRule);
            result = rules.transformFIXMsg(TestExprParen.sampleMessage1, true);
            System.out.println(StaticTestingUtils.rs(result));
            resultStore = StaticTestingUtils.parseMessage(result);
            Assert.assertEquals(resultStore.get(218).get(0), "42");
        } catch (Exception e) {
            e.printStackTrace();
            Assert.fail();
        }
    ...
    public void test15() {
        try {
            ...
            sampleRule = "&215[1]->&218 = 42";
            rules = new InfixActions(sampleRule);
            result = rules.transformFIXMsg(TestExprParen.sampleMessage2, true);
            System.out.println(result);
            resultStore = StaticTestingUtils.parseMessage(result);
            Assert.assertEquals(resultStore.get(218).get(0), "42");
            sampleRule = "&35=8;&215[1]->&218 = 42";
            rules = new InfixActions(sampleRule);
            result = rules.transformFIXMsg(TestExprParen.sampleMessage2, true);
            System.out.println(result);
            resultStore = StaticTestingUtils.parseMessage(result);
